...
export default function StoriesPage() {
  ...
  // Listes dynamiques de catégories & auteurs
  ...
  const listHeaderComponent = (
    <View style={[styles.listHeader, { backgroundColor: bgColor }]}>
      {/* Barre de recherche */}
      ...
      {authors.length > 0 && (
        <>
          <Pressable
            style={styles.authorToggle}
            onPress={() => setShowAuthorFilter((v) => !v)}
          >
            <Text style={[styles.filterLabel, { color: C.medium, marginBottom: 0 }]}>
              Auteurs
            </Text>
            <Ionicons
              name={showAuthorFilter ? "chevron-up" : "chevron-down"}
              size={16}
              color={C.medium}
            />
          </Pressable>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.chipRow}>
              ...
              {authors.map((a) => (
                <FilterChip
                  ...
                  onPress={() =>
                    setSelectedAuthor(selectedAuthor === a.nom ? null : a.nom)
                  }
                />
              ))}
            </ScrollView>
      ...
      <View style={styles.resultRow}>
        ...
        {(selectedCategory || selectedAuthor || searchQuery) && (
          ...
          >
            <Text style={[styles.clearAll, { color: C.primary }]}>
              Tout effacer
            </Text>
          </Pressable>
        )}
