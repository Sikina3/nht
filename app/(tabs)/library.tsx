...
function ReadingCard({
  ...
  return (
    <TouchableOpacity
      style={[
        styles.readingCard,
        { backgroundColor: C.cardBg, borderColor: C.borderColor },
      ]}
      onPress={onPress}
      activeOpacity={0.75}
    >
      ...
      <View style={styles.readingInfo}>
        <Text
          style={[styles.readingTitle, { color: C.text }]}
          numberOfLines={1}
        >
          {item.storyTitle}
        </Text>
        ...
        <Text
          style={[styles.readingChapter, { color: C.medium }]}
          numberOfLines={1}
        >
  ...
  return (
    ...
    >
      ...
      <View style={styles.downloadInfo}>
        <Text
          style={[styles.downloadTitle, { color: C.text }]}
          numberOfLines={2}
        >
          {item.titre}
        </Text>
        ...
        <View style={styles.downloadBadgeRow}>
          <View
            style={[styles.badge, { backgroundColor: "rgba(59,130,246,0.15)" }]}
          >
            <Ionicons
